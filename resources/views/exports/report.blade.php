<table cellspacing="0" border="0">
    ...
    <tr>
        @for($i = 1; $i <= $month_days; $i++)
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" rowspan=4 align="center" valign=middle sdval="1" sdnum="1033;"><b><font face="Sylfaen" color="#000000">{{ $i }}</font></b></td>
        @endfor
    ...
    @foreach($users as $user)
        <tr>
            ...
            <td style="border-top: 1px solid #000000; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000" align="center" valign=middle><b><font color="#000000">{{ $user['data']['position_name'] }}</font></b></td>
            @php
                $totalWorkedHours = 0;
                $totalWorkedDays = 0;
                $totalHolidays = 0;
