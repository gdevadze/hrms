...
<head>
    ...
    <meta charset="utf-8" />
    <title>HRMS - თანამშრომლების აღრიცხვის პროგრამა</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="თანამშრომლების აღრიცხვის პროგრამა" name="description" />
    <meta content="Magellan" name="author" />
    <!-- App favicon -->
            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-sm">
                            <img src="{{ asset('assets/images/asya-white.svg') }}" alt="" height="22">
                        </span>
                            <span class="logo-lg">
                            <img src="{{ asset('assets/images/asya-white.svg') }}" alt="" height="17">
                        </span>
                        </a>
...
{{--                            <img id="header-lang-img" src="{{ asset('assets/images/flags/us.svg') }}" alt="Language" height="20"--}}
{{--                                 class="rounded">--}}
{{--                        </button>--}}
...
{{--                                <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Founder</span>--}}
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">მოგესალმებით {{ currentUser()->name }}!</h6>
...
{{--                                    class="align-middle">Lock screen</span></a>--}}
                            <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                    ...
                                    class="align-middle" data-key="t-logout">გასვლა</span></a>
    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('assets/images/asya-white.svg') }}" alt="" height="30">
                    </span>
                <span class="logo-lg">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="text-sm-end d-none d-sm-block">
                        Design & Develop by <a href="https://magellan.ge" target="_blank">Magellan</a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function()
    {
        ...
        $("#cTime").clock({"calendar":"false", "format":"24","langSet":"ge","timestamp":cts});
    });
</script>
</body>
</html>
