            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        ...
                        <span class="logo-sm">
                            <img src="https://giftoy.ge/assets/images/logo_white.png" alt="" height="22">
                        </span>
                            <span class="logo-lg">
                            <img src="https://giftoy.ge/assets/images/logo_white.png" alt="" height="17">
                        </span>
                        </a>
...
{{--                                    class="align-middle">Lock screen</span></a>--}}
    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="{{ route('dashboard') }}" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="https://giftoy.ge/assets/images/logo_white.png" alt="" height="30">
                    </span>
                <span class="logo-lg">
                        <img src="https://giftoy.ge/assets/images/logo_white.png" alt="" height="50">
                    </span>
            </a>
