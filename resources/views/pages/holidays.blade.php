                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">დასვენების დღეები</h4>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">დასვენების დღეები</h4>
                        <div class="flex-shrink-0">
                            <a type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#myModal" href="javascript:void(0)"><i class="fa fa-plus-square-o"></i> დამატება</a>
                        </div>
                    </div><!-- end card header -->
                    <div class="card-body">
            ...
            <div class="modal-content">
                <form action="javascript:void(0)" method="POST" id="add_holiday">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myModalLabel">დასვენების დღის დამატება</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <label for="basiInput" class="form-label">თარიღი</label>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">დახურვა</button>
                        <button type="button" class="btn btn-primary" id="SaveBtn">შენახვა</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
