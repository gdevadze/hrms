                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">@lang('vacations')</h4>
                ...
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        ...
                        <div class="flex-shrink-0">
                            <a type="button" class="btn btn-primary waves-effect waves-light" id="add_honorable_reason" href="javascript:void(0)"><i class="fa fa-plus-square-o"></i> @lang('add')</a>
                        </div>
                        @endif
                    </div><!-- end card header -->
                    <div class="card-body">
                        <p>@lang('remaining_vacation_days',['value' => $vacationDays])</p>
                        <div class="table-responsive">
                            <table id="users" class="table table-striped table-bordered" >
                                <thead>
                                <tr>
                                    <th scope="col">#</th>
                                    <th scope="col">@lang('honorary_cause')</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_title">@lang('vacation_request')</h5>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#users').DataTable({
                ...
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'honorable_reason_type', name: 'honorable_reason_type'},
                    {data: 'honorable_reason_dates', name: 'honorable_reason_dates'},
        ...
        $(document.body).on('click', '#add_honorable_reason', function () {
            ...
            $.ajax({
                url: "{{ route('user.vacations.create') }}",
                method: "POST",
                data: {
                    _token: '{{ csrf_token() }}',
                },
