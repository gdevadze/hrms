                        ...
                        <div class="table-responsive">
                            <table id="users" class="table table-striped table-bordered" >
                                ...
                                <tr>
                                    ...
                                    <th scope="col">@lang('vacation_type')</th>
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#users').DataTable({
                ...
                columns: [
                    ...
                    {data: 'honorable_reason_type', name: 'reason_type'},
                    {data: 'honorable_reason_dates', searchable:false},
                    {data: 'formatted_status', name: 'status'},
        ...
        function confirmHonorableReason(id){
            Swal.fire({
                title: '@lang('are_you_want_confirm_vacation')',
                text: "",
                icon: 'question',
                        ...
                        $.ajax({
                            ...
                            .done(function (response) {
                                if (response.status === 1) {
                                    Swal.fire('@lang('successful')!','@lang('vacation_confirmed_successfully')!','success');
                                    reload()
                                } else {
        ...
        function rejectVacation(id){
            Swal.fire({
                title: '@lang('are_you_want_reject_vacation')',
                text: "",
                icon: 'question',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
