                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">@lang('work_schedule')</h4>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1">@lang('work_schedule')</h4>
                        <div class="flex-shrink-0">
                            <a type="button" class="btn btn-primary waves-effect waves-light" href="{{ route('working.schedule.create') }}"><i class="fa fa-plus-square-o"></i> @lang('add')</a>
                        </div>
                    </div><!-- end card header -->
                    <div class="card-body">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            table = $('#working_schedule').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('working.schedule.ajax') }}",
                    type: 'GET',
                },
                columns: [
