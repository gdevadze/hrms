        ...
        <ul class="navbar-nav" id="navbar-nav">
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('dashboard') }}">
                    <i class="ri-honour-line"></i> <span data-key="t-widgets">@lang('home')</span>
                </a>
            </li>
...
{{--                <li class="menu-title"><span data-key="t-menu">Menu</span></li>--}}
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ri-time-line"></i> <span data-key="t-dashboards">@lang('schedule')</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('holidays.index') }}" class="nav-link"
                                   data-key="t-analytics"> @lang('holidays') </a>
                            </li>
                            @if(currentUser()->working_schedule_id == 2)
                            <li class="nav-item">
                                <a href="{{ route('user.working.schedule') }}" class="nav-link"
                                   data-key="t-analytics">პირადი სამუშაო გრაფიკი</a>
                            </li>
                            @endif
                            @if(currentUser()->hasRole('System Administrator'))
                            <li class="nav-item">
                                <a href="{{ route('working.schedule.index') }}" class="nav-link"
                                   data-key="t-analytics"> @lang('work_schedule') </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('dynamic.working.schedule.time.index') }}" class="nav-link"
                                   data-key="t-analytics"> დინამიური გრაფიკის სამუშაო დროის მართვა </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('dynamic.working.schedule.index') }}" class="nav-link"
            ...
            @if(currentUser()->hasRole('System Administrator'))
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('vacations.index') }}">
                        <i class="ri-calendar-2-line"></i> <span data-key="t-widgets">@lang('vacations')</span>
                    </a>
                </li>
            @endif
            ...
            @if(!currentUser()->hasRole('User'))
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarEmployees" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ri-account-box-fill"></i> <span data-key="t-dashboards">@lang('employees')</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('users.index') }}" class="nav-link"
                                   data-key="t-analytics"> @lang('employees_management') </a>
                            </li>
                            @endcan
                            <li class="nav-item">
                                <a href="{{ route('users.delays') }}" class="nav-link"
                                   data-key="t-analytics"> დაგვიანების მიზეზები </a>
                            </li>
                                <li class="nav-item">
                                    <a href="{{ route('users.subordinates') }}" class="nav-link"
            ...
            @if(currentUser()->hasRole('System Administrator'))
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarReports">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('reports.movements.index') }}" class="nav-link"
...
{{--                            </li>--}}
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('user.vacations.index') }}">
                    <i class="ri-calendar-2-line"></i> <span data-key="t-widgets">პირადი @lang('vacations')</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('user.movements.index') }}">
                    <i class="fa fa-map-signs"></i> <span data-key="t-widgets">პირადი @lang('movements')</span>
                </a>
            </li>
