        ...
        <ul class="navbar-nav" id="navbar-nav">
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('dashboard') }}">
                    <i class="ri-honour-line"></i> <span data-key="t-widgets">მთავარი</span>
                </a>
            </li>
            <li class="menu-title"><span data-key="t-menu">Menu</span></li>
            <li class="nav-item">
                <a class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                    <i class="ri-calendar-2-line"></i> <span data-key="t-dashboards">განრიგი</span>
                </a>
                <div class="collapse menu-dropdown" id="sidebarDashboards">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a href="{{ route('holidays.index') }}" class="nav-link" data-key="t-analytics"> დასვენების დღეები </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('working.schedule.index') }}" class="nav-link" data-key="t-analytics"> სამუშაო განრიგი </a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link menu-link" href="{{ route('users.index') }}">
                    <i class="ri-account-box-fill"></i> <span data-key="t-widgets">თანამშრომლები</span>
                </a>
            </li>
{{--            <li class="nav-item">--}}
